"""VAE class
SOURCE: Markham, A., Liu, M., Aragam, B., & Solus, L. (2023), https://gitlab.com/alex-markham/medil/-/blob/ncfa/learning/vae.py"""
from scripts.medil.sparse_linear import SparseLinear
