"""UDG estimation using independence testing per original NCFA
SOURCE: Markham, A., Liu, M., Aragam, B., & Solus, L. (2023), https://gitlab.com/alex-markham/medil/-/blob/ncfa/graph_est/estimation.py"""
from scripts.medil.ecc_algorithms import find_clique_min_cover
from scripts.medil.ecc_algorithms import find_heuristic_clique_cover
